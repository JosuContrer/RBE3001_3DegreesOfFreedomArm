...
try
  SERV_ID = 03;            % we will be talking to server ID 37 on
                           % the Nucleo
  ...
  for k = viaPts
      ...
      for i=1:length(returnPacket)
          fprintf(fid, '%d,', returnPacket(i));
      end
...
+3)=0;
      ...
      returnPacket2=  pp.read(02);
       ...
       for i=1:length(returnPacket2)
           fprintf(fid, '%d,', returnPacket2(i));
       end
